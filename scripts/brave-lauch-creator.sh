...
default_chrome_desktop=/usr/share/applications/brave-browser.desktop
...
user_data_dir_name="brave-browser-${safe_display_name}"
user_data_dir="${HOME}/.config/BraveBrowser/Brave-Browser/${user_data_dir_name}"
shortcut="${HOME}/.local/share/applications/${user_data_dir_name}.desktop"

#echo ${user_data_dir_name}
#echo ${user_data_dir}
#exit
...
chrome_name="Brave Web Browser"
short_chrome_name="Brave"
sed -i "s:Name=${chrome_name}:Name=${short_chrome_name} (${display_name}):g" "${shortcut}"
